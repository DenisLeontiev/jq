import {
  inject,
  InjectionKey, onBeforeUnmount, onMounted,
  provide, ref, watchEffect,
} from "vue";
import { OptionalRef, RefablePick } from "../../src/types";
import {
  getAllClosest, getMaybeRef, isSSR, logWarn,
} from "../utils";
...
export const usePopup = (
  ...
  watchEffect((onInvalidate) => {
    ...
    if (!popups) {
      logWarn("POPUP", "Unable to use popup. There is no container provided");
